...
//		int formatType = DATE_TIME;
	...
	public void printFormattedDateTime(Date currentDate, Locale locale, int style, int formatType) {
...
//		String pattern = "yyyy/MM/dd hh:mm";
		String pattern = "MMM dÀÏ E";
		printDateWithPattern(date, pattern);
		
	}
	
	public void printDateWithPattern(Date date, String pattern) {
